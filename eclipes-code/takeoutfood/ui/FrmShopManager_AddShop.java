...
public class FrmShopManager_AddShop  extends JDialog implements ActionListener {
	...
	private JLabel labelUserid = new JLabel("店主账号：");
	private JLabel labelUsername = new JLabel("姓名：");
	private JLabel labelAdminpwd = new JLabel("密码:");
	private JTextField edtUserid = new JTextField(20);
	private JTextField edtUsername = new JTextField(20);
	private JPasswordField passwordField= new JPasswordField(20);
	private final JLabel label = new JLabel("商家星级");
	private final JComboBox comboBox = new JComboBox();
	public FrmShopManager_AddShop(JDialog f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			int shopstar=this.comboBox.getSelectedIndex();
			shop=new BeanShop();
